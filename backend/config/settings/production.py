...
# Security Settings
# Traefik handles SSL termination — trust its X-Forwarded-Proto header
...
# Cache - Redis en producción (using Django's native Redis backend)
CACHES = {
    'default': {
