...
urlpatterns = [
    ...
    path('admin/reset-catalog/', ResetCatalogView.as_view(), name='reset_catalog'),
    ...
    path('books/import-template/', BookImportTemplateView.as_view(), name='book_import_template'),
